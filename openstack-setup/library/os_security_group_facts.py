...
def main():
    argument_spec = openstack_full_argument_spec(filters=dict(required=False, type='dict', default=None))
    ...
    try:
        ...
        security_groups = cleanProtocol(cloud.list_security_groups(module.params['filters']))
